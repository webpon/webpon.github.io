import{_ as s,c as a,o as n,a as e}from"./app.eb325cc6.js";const g=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"front-end/编程工具库/serve.md"}'),p={name:"front-end/编程工具库/serve.md"},l=e(`<blockquote><p>用来开启静态资源服务器</p></blockquote><p>安装</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-palenight"><code><span class="line"><span style="color:#A6ACCD;">	npm i serve -g</span></span>
